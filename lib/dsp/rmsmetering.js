...
export default class RmsMetering extends AbstractNode
{
    ...
    constructor( audioContext )
    {
        ...
        /// the script processor part
        {
            ...
            const numberOfOutputChannels = 1;   ///< as a matter of fact, the script processor
        ...
        this._scriptNode.connect( audioContext.destination, 0, 0 );
    }
...
export class MultiRMSMetering extends AbstractNode
{
                 ...
                 numChannels )
    {
        ...
        {
            const newRmsNode = new RmsMetering( audioContext );
            this._meterNodes.push( newRmsNode );
        }
        ...
        for( let i = 0; i < numChannels; i++ )
        {
            this._splitterNode.connect( this._meterNodes[i]._input, i, 0 );
        }
    }
