...
import PeakLimiterNode from '../dsp/peaklimiter.js'
import MultiCompressorExpanderNode from '../dsp/compressorexpander.js'
 ...
 */
/************************************************************************************/
export default class NewSmartFader extends AbstractNode
{
                ...
                audioStreamDescriptionCollection = undefined )
    {
        ...
        this._attackTime = NewSmartFader.defaultAttackTime;
        this._releaseTime = NewSmartFader.defaultReleaseTime;
        ...
        this._peakLimiterNode = new PeakLimiterNode( audioContext, totalNumberOfChannels_ );
    ...
    {
        const [minValue, maxValue] = NewSmartFader.dBRange;
    ...
    get dynamicCompressionState()
    {
        ...
        const reduction = this._peakLimiterNode.getMaxGainReduction();
    ...
    {
        const [minValue, maxValue] = NewSmartFader.compressionRatioRange;
    ...
    {
        const [minValue, maxValue] = NewSmartFader.attackTimeRange;
    ...
    {
        const [minValue, maxValue] = NewSmartFader.releaseTimeRange;
    ...
    _updateCompressorSettings()
    {
        ...
        this._peakLimiterNode.setThreshold( utilities.dB2lin( 0 ) );
