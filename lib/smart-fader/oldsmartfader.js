 ...
 */
/************************************************************************************/
export default class OldSmartFader extends AbstractNode
{
                ...
                audioStreamDescriptionCollection = undefined )
    {
        ...
        this._dB = 0.0;
        this._compressionRatio = OldSmartFader.defaultCompressionRatio;
        this._attackTime = OldSmartFader.defaultAttackTime;
        this._releaseTime = OldSmartFader.defaultReleaseTime;
    ...
    {
        const [minValue, maxValue] = OldSmartFader.dBRange;
    ...
    {
        const [minValue, maxValue] = OldSmartFader.attackTimeRange;
