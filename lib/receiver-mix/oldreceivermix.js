...
export default class OldReceiverMix extends AbstractNode
{
    //==============================================================================
    /**
                 ...
                 audioStreamDescriptionCollection = undefined )
    {
        ...
        this._thresholdForCommentary = OldReceiverMix.defaultForCommentaryThreshold;
        
        /// this is the X value in the .pdf :
        /// when the RMS of the programme P is > X, the programme is compressed
        this._thresholdForProgramme = OldReceiverMix.defaultForProgrammeThreshold;
        ...
        this._dynamicCompressorNode.setRatio( OldReceiverMix.defaultCompressionRatio );
        this._dynamicCompressorNode.setAttack( utilities.ms2sec( OldReceiverMix.defaultAttackTime ) );
        this._dynamicCompressorNode.setRelease( utilities.ms2sec( OldReceiverMix.defaultReleaseTime ) );
    ...
    {
        const [minValue, maxValue] = OldReceiverMix.rangeForCommentaryThreshold;
    ...
    setThresholdForProgrammeFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = OldReceiverMix.rangeForProgrammeThreshold;
    ...
    setCompressorThresholdFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = OldReceiverMix.compressionThresholdRange;
    ...
    setReleaseTimeFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = OldReceiverMix.releaseTimeRange;
    ...
    setAttackTimeFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = OldReceiverMix.attackTimeRange;
    ...
    setCompressionRatioFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = OldReceiverMix.compressionRatioRange;
