...
import RmsMetering from '../dsp/rmsmetering.js';
...
export default class NewReceiverMix extends AbstractNode
{
                ...
                audioStreamDescriptionCollection = undefined )
    {
        ...
        this._analysisNodeCommentary = new RmsMetering( audioContext );
        ...
        this._dynamicCompressorNode.setRatio( NewReceiverMix.defaultCompressionRatio );
        this._dynamicCompressorNode.setAttack( utilities.ms2sec( NewReceiverMix.defaultAttackTime ) );
        this._dynamicCompressorNode.setRelease( utilities.ms2sec( NewReceiverMix.defaultReleaseTime ) );
    ...
    setCompressorThresholdFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = NewReceiverMix.compressionThresholdRange;
    ...
    setReleaseTimeFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = NewReceiverMix.releaseTimeRange;
    ...
    setAttackTimeFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = NewReceiverMix.attackTimeRange;
    ...
    setCompressionRatioFromGui( theSlider )
    {
        ...
        // get the actual bounds for this parameter
        const [minValue, maxValue] = NewReceiverMix.compressionRatioRange;
    ...
    getRmsForCommentary()
    {
        ...
        {
            return utilities.lin2dBsafe( this._analysisNodeCommentary.GetValuedB() );
        }
        else
        {
            return -200;
    ...
    getRmsForProgram()
    {
        if( this._hasProgramToAnalyze() === true )
        {
            ...
            {
                const lin = this._analysisNodeProgram[i].GetValue();
    ...
    _updateAudioGraph()
    {
        ...
        if( this._hasProgramToAnalyze() === true )
        {
            ...
            {
                const newAnalyzer = new RmsMetering( this._audioContext );
